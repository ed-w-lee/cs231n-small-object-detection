...
_C.MODEL.RPN.AREA_LOSS_BETA = 0.5
_C.MODEL.RPN.AREA_LOSS_THRESHOLD = 32*32
...
_C.MODEL.ROI_HEADS.CLS_LOSS_WT = 1.0
_C.MODEL.ROI_HEADS.BBOX_LOSS_WT = 1.0
_C.MODEL.ROI_HEADS.CLASSIFICATION_LOSS_FN = "CE"
_C.MODEL.ROI_HEADS.CLASSIFICATION_LOSS_NORM = "Sigmoid"
...
_C.MODEL.ROI_HEADS.AREA_LOSS_BETA = 0.5
_C.MODEL.ROI_HEADS.AREA_LOSS_THRESHOLD = 32*32
