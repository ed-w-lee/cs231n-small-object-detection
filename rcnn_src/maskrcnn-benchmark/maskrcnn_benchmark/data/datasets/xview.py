...
class XViewDataset(torchvision.datasets.coco.CocoDetection):
    ...
    # constants
    SPLITS = OrderedDict([
        ('mAP/small', [17,18,19,20,21,23,24,26,27,28,32,41,60,62,63,65,66,91]),
        ('mAP/medium', [11,12,15,25,29,33,34,35,36,37,38,42,44,47,50,53,56,59,61,71,72,73,76,84,86,93,94]),
